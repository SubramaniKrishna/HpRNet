...
class varP:
	...
	def initUI(self):
		...
		self.filelocation.insert(0, '/home/krishna/Desktop/IITB/DDP/Datasets/Annotated Data/Behringer/Gamakas/01-G_MMG_1.wav')
		...
		# self.pR.insert(0, '/home/krishna/Desktop/IITB/DDP/Main/ddp-genmodels/pitch_gen/Carnatic/ISMIR_expts/paramshpr/synthmanifold(2020-05-25 00:57:21.534347)_[50, False, [50, 50], 32, [32, 50, 50], 0]_niters_2000_lr_0.001_beta_0.1_netR.pth')
		...
		self.compute.grid(row=4, column=0, padx=5, pady=(10,15), sticky=W)
		...
		output_label = "Input Harmonic : "
		Label(self.parent, text=output_label).grid(row=5, column=0, sticky=W, padx=5, pady=(10,0))
		...
		self.output.grid(row=5, column=0, padx=(150,5), pady=(10,0), sticky=W)

		#BUTTON TO PLAY STOCHASTIC OUTPUT
		output_label = "Network reconstruction : "
		Label(self.parent, text=output_label).grid(row=6, column=0, sticky=W, padx=5, pady=(5,0))
		...
		self.output.grid(row=6, column=0, padx=(150,5), pady=(5,0), sticky=W)
	...
	def compute_model(self):
		...
		try:
			...
			varPitch_function.main(inputFile,pH)
